//
//  HistoryAndCommentController.m
//  OJEX
//
//  Created by alham fikri on 1/22/13.
...
@interface HistoryAndCommentController ()

@end

NSString* mode = @"Comment";

@implementation HistoryAndCommentController
...
{
    if(mode == @"History"){
        return 83; //history cell have fixed height
    }
    else{
        return 135; //comment cell have different height
    }
}
